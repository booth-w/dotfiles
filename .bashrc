...
alias dot-sync="~/scripts/dot-sync-save.sh"
...
alias lg="lazygit"
alias ls="ls -l -G -h --si -p --group-directories-first --time-style='+%F %T' --color=auto"
...
alias yay="yay --sudoloop --answerdiff None --answerclean None"
