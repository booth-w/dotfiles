...
local widget_types = {
    icon_and_text = require("awesome-wm-widgets.wpctl-widget.widgets.icon-and-text-widget"),
    icon = require("awesome-wm-widgets.wpctl-widget.widgets.icon-widget"),
    arc = require("awesome-wm-widgets.wpctl-widget.widgets.arc-widget"),
    horizontal_bar = require("awesome-wm-widgets.wpctl-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("awesome-wm-widgets.wpctl-widget.widgets.vertical-bar-widget")
}
local volume = {}
